    ...
    <>
      <main>
        ...
        <section className="hero" id="games-hero">
          ...
          <p>
            Scegli il tuo modo di giocare: strategie, competizione e avventura
            ti aspettano!
          </p>
        </section>
        ...
        {/* Skyblock */}
        <section
          onClick={() => (window.location.href = "/SkyBlock")}
          id="skyblock"
        ...
        >
          <div className="container">
            ...
            <div className="how-to-play">
              ...
              <ol>
                <li>
                  Unisciti con <code>play.nightrp.it</code> e seleziona
                  Skyblock.
                </li>
                <li>
                  Raccogli il materiale base e crea il tuo cobblestone
                  generator.
                </li>
                <li>
                ...
                <li>
                  Ogni domenica la classifica viene azzerata: punta al primo
                  posto!
                </li>
              </ol>
            </div>
        ...
        {/* KitPvP */}
        <section
          onClick={() => (window.location.href = "/KitPVP")}
          id="kitpvp"
        ...
        >
          <div className="container">
            ...
            <div className="how-to-play">
              ...
              <p>
                Ogni kit include armatura e armi casuali. Guadagna kill per
                salire di livello e sbloccare ricompense. Partecipa ai tornei
                settimanali per premi esclusivi!
              </p>
            </div>
        ...
        {/* Prison */}
        <section
          onClick={() => (window.location.href = "/Prison")}
          id="prison"
          className="mode-details mode-card"
        >
          <div className="container">
            ...
            <p className="mode-intro">
              Da prigioniero a magnate: scava, commercia e investi. Scala i
              ranghi per ottenere libertà e ricompense esclusive.
            </p>
            ...
            <div className="how-to-play">
              ...
              <ul>
                <li>
                  Inizia nella cella e scava blocchi per ottenere risorse.
                </li>
