        ...
        <section id="storia">
          <div className="container">
            ...
            <p>
              ...
              repellendus nam, eaque corrupti veritatis eum totam consequatur
              harum, aliquid unde sint accusantium ut dicta sunt necessitatibus
              officiis quia tenetur dolorem! Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Aut amet quasi incidunt quod id
              eligendi nulla nam eum. Esse reprehenderit debitis consectetur
              incidunt tempora nulla neque magni eveniet assumenda perspiciatis!
            </p>
          </div>
        </section>
        ...
        <section id="mission">
          <div className="container">
            ...
            <p>
              ...
              nobis, quaerat at ab accusantium earum magni, dignissimos
              quibusdam dolor temporibus quos omnis alias explicabo? Dolores
              fuga aperiam optio labore laboriosam? Lorem ipsum, dolor sit amet
              consectetur adipisicing elit. Suscipit, inventore. Odit aspernatur
              maiores repellendus corrupti nemo suscipit laborum harum dolore
              itaque voluptate quis, ex repudiandae officiis excepturi, dicta
              recusandae tempora.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="cards">
              <div className="card">
                ...
                <span>Community</span>
                <p>
                  Supporto e rispetto reciproco per costruire insieme un
                  ambiente positivo.
                </p>
              </div>
              <div className="card">
                ...
                <p>
                  Plugin personalizzati e contenuti originali per un gameplay
                  sempre fresco.
                </p>
              </div>
              <div className="card">
                ...
                <p>
                  Tornei, sfide e classifiche per chi ama mettersi alla prova.
                </p>
              </div>
            </div>
          </div>
